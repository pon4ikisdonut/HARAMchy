...
for f in cc1 collect2 libgcc_s.so.1 libgcc.a crtbeginS.o crtendS.o crtbeginT.o crtbegin.o crtend.o lto-wrapper lto1; do
...
mkdir -p "$LFS/var/log" "$LFS/tmp/build" "$LFS/home/lfs/.build-markers/wayland"

echo "=== Running Wayland Stack Build ==="
